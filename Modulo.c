...
int main() {
    ...
    printf("3. Ayuda a mejorar la legibilidad, mantenibilidad y organizacion del codigo, al tiempo que permite un enfoque modular y estructurado en el desarrollo de software.\n");
    printf("\n\n");
    do {
